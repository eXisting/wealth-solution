...
const InitialValuesPage = () => {
  ...
  return (
    <Container>
      ...
      <Section backgroundColor="white" ignore>
        <VerticalStack style={{paddingLeft:"4vw", paddingRight:"4vw"}} space="2vh">
          ...
          <NumbericSnaps
            ...
            inputFieldHeight={"5.5vh"}
            custom={true}
          />
          <span style={{ fontSize: '3vh', textAlign:"center"}}>How much money do <br/>you have saved?</span>
          <NumbericSnaps 
      ...
      <Section ignore width="95%" style={{marginTop:"3vh"}}>
        <span style={{ fontSize: '3.5vh', paddingTop: "0.5vh", paddingBottom: "0.5vh", textAlign:"center"}}>
          Choose your wealth
        </span>
      </Section>
      <Section justify={"top"} style={{marginTop:'1vh'}}>
